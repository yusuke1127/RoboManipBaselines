...
```console
$ python TeleopMujocoUR5eCable.py
```
...
```console
$ python TeleopMujocoUR5eCable.py --world_idx_list 0 5
```

To add a 3D plot of the point cloud, add the following option:
```console
$ python TeleopMujocoUR5eCable.py --enable_3d_plot
```
...
```console
$ python TeleopMujocoUR5eCable.py --replay_log ./teleop_data/UR5eCable/env0/UR5eCable_env0_000.npz
```
